          ...
          <div className="space-y-6">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
              ...
              <TabsContent value="security" className="space-y-6">
                ...
                <Card>
                  <CardHeader>
                    <CardTitle>Banking PIN</CardTitle>
                    <CardDescription>
                      Update your secure banking PIN
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <form onSubmit={(e) => {
                      ...
                      if (!currentPassword || !newPin) {
                        toast({
                          ...
                          description: "Both current password and new PIN are required",
                          variant: "destructive"
                        });
                        return;
                      }
                      ...
                      changePinMutation.mutate({ currentPassword, newPin });
                    }} className="space-y-4">
                      <div className="space-y-2">
                        <FormItem>
                          <FormLabel>Current Password</FormLabel>
                        ...
                        <FormItem>
                          ...
                          <FormDescription>
                            Your banking PIN should be 4 digits
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      </div>
